...
// @downloadURL  https://raw.githubusercontent.com/deepgogoi1/public/main/blum.js
// @updateURL    https://raw.githubusercontent.com/deepgogoi1/public/main/blum.js
// @homepage     https://github.com/deepgogoi1/public
// ==/UserScript==
...
async function fetchAndUpdateCodes() {
	try {
		const updatedSecretCodes = await fetch(
			"https://raw.githubusercontent.com/deepgogoi1/public/main/answers.json"
		).then(res => {
			if (!res.ok)
				return {};
			try {
...
try {
	...
	githubButton.href = 'https://github.com/deepgogoi1/public';
	...
	telegramButton.href = 'https://t.me/DEEcryPto_o';
	...
	donateButton.href = 'https://t.me/user_alived';
